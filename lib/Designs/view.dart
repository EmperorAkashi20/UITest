...
class View extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
        () => viewController.airData.value.data == null
            ? const Offstage()
            : SizedBox(
                  ...
                  children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(
                                  viewController.airData.value.data!.imageUrl
                                      .toString(),
                                ),
                                fit: BoxFit.cover,
                              ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        viewController
                                            .airData.value.data!.categoryName
                                            .toString(),
                                      ...
                                      Text(
                                        viewController
                                            .airData.value.data!.description
                                            .toString(),
                                        style: const TextStyle(
                                          fontSize: 15,
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if (index ==
                            viewController
                                .airData.value.data!.services!.length) {
